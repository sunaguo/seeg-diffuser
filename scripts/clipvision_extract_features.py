...
test_images = batch_generator_external_images(data_path = image_path, transpose=(0,1,2,3))
...
num_embed, num_features, num_test = 257, 768, len(test_images)
...
with torch.no_grad():
    ...
    np.save('ecog_data/extracted_features/cars-2_clipvision.npy',test_clip)
