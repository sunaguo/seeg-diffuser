...
pred_outdir = f"ecog_data/predicted_features/clipvision/{out_config}"
wts_outdir = f"ecog_data/regression_weights/clipvision/{out_config}"
...
## load clipvision feats
print("loading clipvision feats")
...
all_clip = np.load('ecog_data/extracted_features/cars-2_clipvision.npy')
...
np.save(f'ecog_data/regression_weights/clipvision/overall_score/{out_config}.npy',scores)
...
# with open(f'data/regression_weights/clipvision_regression_weights/{out_config}.pkl',"wb") as f:
#     pickle.dump(datadict,f)